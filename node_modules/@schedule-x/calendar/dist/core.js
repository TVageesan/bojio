...
function AppWrapper({ $app }) {
    ...
    return (jsx(Fragment, { children: jsx("div", { className: classes.join(' '), children: jsxs(AppContext$1.Provider, { value: $app, children: [jsx(AppInput, {}), $app.datePickerState.isOpen.value && appPopupJSX] }) }) }));
}
...
function ForwardBackwardNavigation() {
    ...
    return (jsx(Fragment, { children: jsxs("div", { className: "sx__forward-backward-navigation", "aria-label": localizedRange, "aria-live": "polite", children: [jsx(Chevron, { disabled: !!($app.config.minDate &&
                        dateFromDateTime(rangeEndMinusOneRange) < $app.config.minDate), onClick: () => navigate('backwards'), direction: 'previous', buttonText: $app.translate('Previous period') }), jsx(Chevron, { disabled: !!($app.config.maxDate &&
...
function CalendarHeader() {
    ...
    const datePickerAppSingleton = new DatePickerAppSingletonBuilder()
        ...
        .build();
    return (jsxs("header", { className: 'sx__calendar-header', children: [jsxs("div", { className: 'sx__calendar-header-content', children: [jsx(TodayButton, {}), jsx(ForwardBackwardNavigation, {}), jsx(RangeHeading, {})] }), jsxs("div", { className: 'sx__calendar-header-content', children: [jsx(ViewSelection, {}), jsx(AppWrapper, { "$app": datePickerAppSingleton })] })] }));
}
...
function TimeGridEvent({ calendarEvent, dayBoundariesDateTime, isCopy, }) {
    ...
    return (jsxs(Fragment, { children: [jsx("div", { id: isCopy ? getTimeGridEventCopyElementId(calendarEvent.id) : undefined, "data-event-id": calendarEvent.id, onClick: handleOnClick, onMouseDown: (e) => createDragStartTimeout(handleStartDrag, e), onMouseUp: (e) => setClickedEventIfNotDragging(calendarEvent, e), onTouchStart: (e) => createDragStartTimeout(handleStartDrag, e), onTouchEnd: (e) => setClickedEventIfNotDragging(calendarEvent, e), className: 'sx__time-grid-event sx__event' + (isCopy ? ' is-event-copy' : ''), tabIndex: 0, style: {
                ...
                }, children: jsxs("div", { "data-ccid": customComponentId, className: "sx__time-grid-event-inner", children: [!customComponent && (jsxs(Fragment$1, { children: [calendarEvent.title && (jsx("div", { className: "sx__time-grid-event-title", children: calendarEvent.title })), jsxs("div", { className: "sx__time-grid-event-time", children: [jsx(TimeIcon, { strokeColor: eventCSSVariables.iconStroke }), getEventTime(calendarEvent.start, calendarEvent.end)] }), calendarEvent.people && (jsxs("div", { className: "sx__time-grid-event-people", children: [jsx(UserIcon, { strokeColor: eventCSSVariables.iconStroke }), concatenatePeople(calendarEvent.people)] }))] })), $app.config.plugins.resize && (jsx("div", { className: 'sx__time-grid-event-resize-handle', onMouseDown: startResize }))] }) }), eventCopy && jsx(TimeGridEvent, { calendarEvent: eventCopy, isCopy: true })] }));
}
...
function TimeGridDay({ calendarEvents, date }) {
    ...
    return (jsx("div", { className: "sx__time-grid-day", "data-time-grid-date": date, onClick: handleOnClick, "aria-label": getLocalizedDate(date, $app.config.locale), children: eventsWithConcurrency.map((event) => (jsx(TimeGridEvent, { calendarEvent: event, dayBoundariesDateTime: dayBoundariesDateTime }, event.id))) }));
}
...
function TimeAxis() {
    ...
    return (jsx(Fragment, { children: jsx("div", { className: "sx__week-grid__time-axis", children: hours.map((hour) => (jsx("div", { className: "sx__week-grid__hour", children: jsx("span", { className: "sx__week-grid__hour-text", children: new Date(0, 0, 0, hour).toLocaleTimeString($app.config.locale, {
                        hour: 'numeric',
                    }) }) }))) }) }));
}
...
function DateAxis({ week }) {
    ...
    return (jsx(Fragment, { children: jsx("div", { className: "sx__week-grid__date-axis", children: week.map((date) => (jsxs("div", { className: getClassNames(date), children: [jsx("div", { className: "sx__week-grid__day-name", children: getDayNameShort(date, $app.config.locale) }), jsx("div", { className: "sx__week-grid__date-number", children: date.getDate() })] }))) }) }));
}
...
function DateGridEvent({ calendarEvent, gridRow, isCopy, }) {
    ...
    return (jsxs(Fragment, { children: [jsxs("div", { id: isCopy ? getTimeGridEventCopyElementId(calendarEvent.id) : undefined, tabIndex: 0, "aria-label": calendarEvent.title +
                ...
                }, children: [!customComponent && (jsxs(Fragment$1, { children: [hasOverflowLeft && (jsx("div", { className: 'sx__date-grid-event--left-overflow', style: overflowStyles })), jsx("span", { className: "sx__date-grid-event-text", children: calendarEvent.title }), hasOverflowRight && (jsx("div", { className: 'sx__date-grid-event--right-overflow', style: overflowStyles }))] })), $app.config.plugins.resize && !hasOverflowRight && (jsx("div", { className: "sx__date-grid-event-resize-handle", onMouseDown: startResize }))] }), eventCopy && (jsx(DateGridEvent, { calendarEvent: eventCopy, gridRow: gridRow, isCopy: true }))] }));
}

function DateGridDay({ calendarEvents }) {
    return (jsx("div", { className: "sx__date-grid-day", children: Object.values(calendarEvents).map((event, index) => {
...
const WeekWrapper = ({ $app, id }) => {
    ...
    return (jsx(Fragment, { children: jsx(AppContext.Provider, { value: $app, children: jsxs("div", { className: "sx__week-wrapper", id: id, children: [jsx("div", { className: "sx__week-header", children: jsxs("div", { className: "sx__week-header-content", children: [jsx(DateAxis, { week: Object.values(week).map((day) => toJSDate(day.date)) }), jsx("div", { className: "sx__date-grid", "aria-label": $app.translate('Full day- and multiple day events'), children: Object.values(week).map((day) => (jsx(DateGridDay, { calendarEvents: day.dateGridEvents }, day.date + new Date().getTime()))) }), jsx("div", { className: "sx__week-header-border" })] }) }), jsxs("div", { className: "sx__week-grid", children: [jsx(TimeAxis, {}), Object.values(week).map((day) => (jsx(TimeGridDay, { calendarEvents: day.timeGridEvents, date: day.date }, day.date + new Date().getTime())))] })] }) }) }));
};
...
function MonthGridEvent({ gridRow, calendarEvent, date, }) {
    ...
    return (jsx("div", { draggable: !!$app.config.plugins.dragAndDrop, "data-event-id": calendarEvent.id, "data-ccid": customComponentId, onMouseDown: (e) => createDragStartTimeout(handleStartDrag, e), onMouseUp: (e) => setClickedEventIfNotDragging(calendarEvent, e), onTouchStart: (e) => createDragStartTimeout(handleStartDrag, e), onTouchEnd: (e) => setClickedEventIfNotDragging(calendarEvent, e), onClick: handleOnClick, className: "sx__event sx__month-grid-event sx__month-grid-cell", style: {
            ...
            backgroundColor: customComponent
                ? undefined
                : eventCSSVariables.backgroundColor,
        }, children: !customComponent && (jsx("div", { className: "sx__month-grid-event-title", children: calendarEvent.title })) }));
}
...
function MonthGridDay({ day, isFirstWeek }) {
    ...
    return (jsxs("div", { className: wrapperClasses.join(' '), "data-date": day.date, onClick: () => $app.config.callbacks.onClickDate &&
            $app.config.callbacks.onClickDate(day.date), children: [jsxs("div", { className: "sx__month-grid-day__header", children: [isFirstWeek ? (jsx("div", { className: "sx__month-grid-day__header-day-name", children: getDayNameShort(dayDate, $app.config.locale) })) : null, jsx("div", { className: dateClassNames.join(' '), children: dayDate.getDate() })] }), jsx("div", { className: "sx__month-grid-day__events", children: Object.values(day.events)
                    ...
                    return (jsx(MonthGridEvent, { gridRow: index + 1, calendarEvent: event, date: day.date }));
                }) }), nEventsInDay > $app.config.monthGridOptions.nEventsPerDay ? (jsx("button", { className: "sx__month-grid-day__events-more sx__ripple--wide", onClick: handleClickAdditionalEvents, children: `+ ${nEventsInDay - $app.config.monthGridOptions.nEventsPerDay} ${getEventTranslationSingularOrPlural(nEventsInDay - $app.config.monthGridOptions.nEventsPerDay)}` })) : null] }));
}

function MonthGridWeek({ week, isFirstWeek }) {
    return (jsx("div", { className: "sx__month-grid-week", children: week.map((day) => (jsx(MonthGridDay, { day: day, isFirstWeek: isFirstWeek }))) }));
}
...
const MonthGridWrapper = ({ $app, id }) => {
    ...
    return (jsx(AppContext.Provider, { value: $app, children: jsx("div", { id: id, className: "sx__month-grid-wrapper", children: month.map((week, index) => (jsx(MonthGridWeek, { week: week, isFirstWeek: index === 0 }, index + new Date().getTime()))) }) }));
};
...
function MonthAgendaDay({ day, isActive, setActiveDate, }) {
    ...
    return (jsxs("div", { className: dayClasses.join(' '), onClick: () => setActiveDate(day.date), children: [jsx("div", { children: toJSDate(day.date).getDate() }), jsx("div", { className: "sx__month-agenda-day__event-icons", children: day.events.slice(0, 3).map((event) => (jsx("div", { style: {
...
function MonthAgendaEvent({ calendarEvent }) {
    ...
    return (jsx("div", { className: "sx__event sx__month-agenda-event", "data-ccid": customComponentId, "data-event-id": calendarEvent.id, style: {
            ...
            borderLeft: customComponent ? undefined : eventCSSVariables.borderLeft,
            padding: customComponent ? '0px' : undefined,
        }, onClick: (e) => onClick(e), children: !customComponent && (jsxs(Fragment$1, { children: [jsx("div", { className: "sx__month-agenda-event__title", children: calendarEvent.title }), jsxs("div", { className: "sx__month-agenda-event__time sx__month-agenda-event__has-icon", children: [jsx(TimeIcon, { strokeColor: `var(--sx-color-on-${calendarEvent._color}-container)` }), getTimeStamp(calendarEvent, $app.config.locale)] })] })) }));
}
...
const MonthAgendaWrapper = ({ $app, id }) => {
    ...
    return (jsx(AppContext.Provider, { value: $app, children: jsxs("div", { id: id, className: "sx__month-agenda-wrapper", children: [jsx(MonthAgendaDayNames, { week: agendaMonth.weeks[0] }), jsx("div", { className: "sx__month-agenda-weeks", children: agendaMonth.weeks.map((week, index) => (jsx(MonthAgendaWeek, { week: week, setActiveDate: setActiveDate, activeDate: activeDate }, index + new Date().getTime()))) }), jsx(MonthAgendaEvents, { events: ((_a = agendaMonth.weeks.flat().find((day) => day.date === activeDate)) === null || _a === void 0 ? void 0 : _a.events) || [] }, activeDate + new Date().getTime())] }) }));
};
