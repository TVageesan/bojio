(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["@schedule-x/calendar"] = {}, global.preact, global.jsxRuntime, global.hooks, global.compat, global.signals));
  ...
  function AppWrapper({ $app }) {
      ...
      return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx("div", { className: classes.join(' '), children: jsxRuntime.jsxs(AppContext$1.Provider, { value: $app, children: [jsxRuntime.jsx(AppInput, {}), $app.datePickerState.isOpen.value && appPopupJSX] }) }) }));
  }
  ...
  function ForwardBackwardNavigation() {
      ...
      return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { className: "sx__forward-backward-navigation", "aria-label": localizedRange, "aria-live": "polite", children: [jsxRuntime.jsx(Chevron, { disabled: !!($app.config.minDate &&
                          dateFromDateTime(rangeEndMinusOneRange) < $app.config.minDate), onClick: () => navigate('backwards'), direction: 'previous', buttonText: $app.translate('Previous period') }), jsxRuntime.jsx(Chevron, { disabled: !!($app.config.maxDate &&
  ...
  function CalendarHeader() {
      ...
      const datePickerAppSingleton = new DatePickerAppSingletonBuilder()
          ...
          .build();
      return (jsxRuntime.jsxs("header", { className: 'sx__calendar-header', children: [jsxRuntime.jsxs("div", { className: 'sx__calendar-header-content', children: [jsxRuntime.jsx(TodayButton, {}), jsxRuntime.jsx(ForwardBackwardNavigation, {}), jsxRuntime.jsx(RangeHeading, {})] }), jsxRuntime.jsxs("div", { className: 'sx__calendar-header-content', children: [jsxRuntime.jsx(ViewSelection, {}), jsxRuntime.jsx(AppWrapper, { "$app": datePickerAppSingleton })] })] }));
  }
  ...
  class CalendarConfigBuilder {
      ...
      build() {
          return new CalendarConfigImpl(this.locale, this.firstDayOfWeek, this.defaultView, this.views, this.dayBoundaries, this.weekOptions, this.calendars, this.plugins, this.isDark, this.callbacks, {}, this.minDate, this.maxDate, this.monthGridOptions);
      }
      withLocale(locale) {
          this.locale = locale;
          return this;
  ...
  function TimeGridDay({ calendarEvents, date }) {
      ...
      return (jsxRuntime.jsx("div", { className: "sx__time-grid-day", "data-time-grid-date": date, onClick: handleOnClick, "aria-label": getLocalizedDate(date, $app.config.locale), children: eventsWithConcurrency.map((event) => (jsxRuntime.jsx(TimeGridEvent, { calendarEvent: event, dayBoundariesDateTime: dayBoundariesDateTime }, event.id))) }));
  }
  ...
  function TimeAxis() {
      ...
      return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx("div", { className: "sx__week-grid__time-axis", children: hours.map((hour) => (jsxRuntime.jsx("div", { className: "sx__week-grid__hour", children: jsxRuntime.jsx("span", { className: "sx__week-grid__hour-text", children: new Date(0, 0, 0, hour).toLocaleTimeString($app.config.locale, {
                          hour: 'numeric',
                      }) }) }))) }) }));
  }
  ...
  function DateAxis({ week }) {
      ...
      return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx("div", { className: "sx__week-grid__date-axis", children: week.map((date) => (jsxRuntime.jsxs("div", { className: getClassNames(date), children: [jsxRuntime.jsx("div", { className: "sx__week-grid__day-name", children: getDayNameShort(date, $app.config.locale) }), jsxRuntime.jsx("div", { className: "sx__week-grid__date-number", children: date.getDate() })] }))) }) }));
  }
  ...
  function DateGridEvent({ calendarEvent, gridRow, isCopy, }) {
      ...
      return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("div", { id: isCopy ? getTimeGridEventCopyElementId(calendarEvent.id) : undefined, tabIndex: 0, "aria-label": calendarEvent.title +
                  ...
                  }, children: [!customComponent && (jsxRuntime.jsxs(preact.Fragment, { children: [hasOverflowLeft && (jsxRuntime.jsx("div", { className: 'sx__date-grid-event--left-overflow', style: overflowStyles })), jsxRuntime.jsx("span", { className: "sx__date-grid-event-text", children: calendarEvent.title }), hasOverflowRight && (jsxRuntime.jsx("div", { className: 'sx__date-grid-event--right-overflow', style: overflowStyles }))] })), $app.config.plugins.resize && !hasOverflowRight && (jsxRuntime.jsx("div", { className: "sx__date-grid-event-resize-handle", onMouseDown: startResize }))] }), eventCopy && (jsxRuntime.jsx(DateGridEvent, { calendarEvent: eventCopy, gridRow: gridRow, isCopy: true }))] }));
  }

  function DateGridDay({ calendarEvents }) {
      return (jsxRuntime.jsx("div", { className: "sx__date-grid-day", children: Object.values(calendarEvents).map((event, index) => {
  ...
  function MonthGridEvent({ gridRow, calendarEvent, date, }) {
      ...
      return (jsxRuntime.jsx("div", { draggable: !!$app.config.plugins.dragAndDrop, "data-event-id": calendarEvent.id, "data-ccid": customComponentId, onMouseDown: (e) => createDragStartTimeout(handleStartDrag, e), onMouseUp: (e) => setClickedEventIfNotDragging(calendarEvent, e), onTouchStart: (e) => createDragStartTimeout(handleStartDrag, e), onTouchEnd: (e) => setClickedEventIfNotDragging(calendarEvent, e), onClick: handleOnClick, className: "sx__event sx__month-grid-event sx__month-grid-cell", style: {
              ...
              backgroundColor: customComponent
                  ? undefined
                  : eventCSSVariables.backgroundColor,
          }, children: !customComponent && (jsxRuntime.jsx("div", { className: "sx__month-grid-event-title", children: calendarEvent.title })) }));
  }
  ...
  function MonthGridDay({ day, isFirstWeek }) {
      ...
      return (jsxRuntime.jsxs("div", { className: wrapperClasses.join(' '), "data-date": day.date, onClick: () => $app.config.callbacks.onClickDate &&
              $app.config.callbacks.onClickDate(day.date), children: [jsxRuntime.jsxs("div", { className: "sx__month-grid-day__header", children: [isFirstWeek ? (jsxRuntime.jsx("div", { className: "sx__month-grid-day__header-day-name", children: getDayNameShort(dayDate, $app.config.locale) })) : null, jsxRuntime.jsx("div", { className: dateClassNames.join(' '), children: dayDate.getDate() })] }), jsxRuntime.jsx("div", { className: "sx__month-grid-day__events", children: Object.values(day.events)
                      ...
                      return (jsxRuntime.jsx(MonthGridEvent, { gridRow: index + 1, calendarEvent: event, date: day.date }));
                  }) }), nEventsInDay > $app.config.monthGridOptions.nEventsPerDay ? (jsxRuntime.jsx("button", { className: "sx__month-grid-day__events-more sx__ripple--wide", onClick: handleClickAdditionalEvents, children: `+ ${nEventsInDay - $app.config.monthGridOptions.nEventsPerDay} ${getEventTranslationSingularOrPlural(nEventsInDay - $app.config.monthGridOptions.nEventsPerDay)}` })) : null] }));
  }

  function MonthGridWeek({ week, isFirstWeek }) {
      return (jsxRuntime.jsx("div", { className: "sx__month-grid-week", children: week.map((day) => (jsxRuntime.jsx(MonthGridDay, { day: day, isFirstWeek: isFirstWeek }))) }));
  }
  ...
  const MonthGridWrapper = ({ $app, id }) => {
      ...
      hooks.useEffect(() => {
          ...
          const filteredEvents = $app.calendarEvents.filterPredicate.value
              ? $app.calendarEvents.list.value.filter($app.calendarEvents.filterPredicate.value)
              : $app.calendarEvents.list.value;
          setMonth(positionInMonth(newMonth, filteredEvents.sort(sortEventsByStartAndEnd)));
      }, [
          (_a = $app.calendarState.range.value) === null || _a === void 0 ? void 0 : _a.start,
          (_b = $app.calendarState.range.value) === null || _b === void 0 ? void 0 : _b.end,
          $app.calendarEvents.list.value,
      ...
      return (jsxRuntime.jsx(AppContext.Provider, { value: $app, children: jsxRuntime.jsx("div", { id: id, className: "sx__month-grid-wrapper", children: month.map((week, index) => (jsxRuntime.jsx(MonthGridWeek, { week: week, isFirstWeek: index === 0 }, index + new Date().getTime()))) }) }));
  };
  ...
  function MonthAgendaDay({ day, isActive, setActiveDate, }) {
      ...
      return (jsxRuntime.jsxs("div", { className: dayClasses.join(' '), onClick: () => setActiveDate(day.date), children: [jsxRuntime.jsx("div", { children: toJSDate(day.date).getDate() }), jsxRuntime.jsx("div", { className: "sx__month-agenda-day__event-icons", children: day.events.slice(0, 3).map((event) => (jsxRuntime.jsx("div", { style: {
  ...
  function MonthAgendaEvent({ calendarEvent }) {
      ...
      return (jsxRuntime.jsx("div", { className: "sx__event sx__month-agenda-event", "data-ccid": customComponentId, "data-event-id": calendarEvent.id, style: {
              backgroundColor: customComponent
                  ? undefined
                  : eventCSSVariables.backgroundColor,
              color: customComponent ? undefined : eventCSSVariables.color,
              borderLeft: customComponent ? undefined : eventCSSVariables.borderLeft,
              padding: customComponent ? '0px' : undefined,
          }, onClick: (e) => onClick(e), children: !customComponent && (jsxRuntime.jsxs(preact.Fragment, { children: [jsxRuntime.jsx("div", { className: "sx__month-agenda-event__title", children: calendarEvent.title }), jsxRuntime.jsxs("div", { className: "sx__month-agenda-event__time sx__month-agenda-event__has-icon", children: [jsxRuntime.jsx(TimeIcon, { strokeColor: `var(--sx-color-on-${calendarEvent._color}-container)` }), getTimeStamp(calendarEvent, $app.config.locale)] })] })) }));
  }
  ...
  const MonthAgendaWrapper = ({ $app, id }) => {
      ...
      return (jsxRuntime.jsx(AppContext.Provider, { value: $app, children: jsxRuntime.jsxs("div", { id: id, className: "sx__month-agenda-wrapper", children: [jsxRuntime.jsx(MonthAgendaDayNames, { week: agendaMonth.weeks[0] }), jsxRuntime.jsx("div", { className: "sx__month-agenda-weeks", children: agendaMonth.weeks.map((week, index) => (jsxRuntime.jsx(MonthAgendaWeek, { week: week, setActiveDate: setActiveDate, activeDate: activeDate }, index + new Date().getTime()))) }), jsxRuntime.jsx(MonthAgendaEvents, { events: ((_a = agendaMonth.weeks.flat().find((day) => day.date === activeDate)) === null || _a === void 0 ? void 0 : _a.events) || [] }, activeDate + new Date().getTime())] }) }));
  };
